...
if __name__ == "__main__":
    ...
    response = opensearch_vector_search_client.configure_search_pipelines("hybrid_search_pipeline", keyword_weight=0.4, vector_weight=0.6)
    ...
    retrieval_chain = create_retrieval_chain(
        retriever=opensearch_vector_search_client.as_retriever(
            search_kwargs={'k': 5, "vector_field": "vector", "search_type":HYBRID_SEARCH,"search_pipeline":"hybrid_search_pipeline",},
        ),
